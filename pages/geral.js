...
<div>
    ...
    {/* Inicio head */}
      ...
      <Head>
        <title>Portal de Noticias - Geral</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
       
        <base href=""/>
        <meta name="description" content="Portal de noticias consumindo api do Google"/>
        <meta name="keywords" content="Portal de noticias, noticias gerais, noticias, geral"/>
        ...
        <meta property="og:title" content="Portal de Noticias - Geral"/>
...
Geral.getInitialProps = async () =>{
    const response = await axios.get(
        'https://newsapi.org/v2/top-headlines?country=br&category=general&apiKey=c6595ed7516847f4a77b8fc01f2f9e6f'
    );
